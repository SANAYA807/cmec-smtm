                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-box">
                                        <div class="card-head">
                                            <header>All Contact List</header>
                                            <div class="tools">
                                                ...
                                                <table
                                                    ...
                                                    <?php
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="left"><?php echo $row['c_name'] ?></td>
                                                            <td class="left"><?php echo $row['c_email'] ?></td>
                                                            <td class="left"><?php echo $row['c_mobile'] ?></td>
                                                            <td class="left"><?php echo $row['c_msg'] ?></td>
